                ...
                <Box display="flex" flexDirection="column" sx={{ padding: "30px" }}>
                            ...
                            <Box
                                ...
                                <Box>
                                    <Box display={"flex"} textAlign={"center"} justifyContent={"center"} alignItems={"center"}  >
                                        ...
                                        >
                                            <Typography sx={{ fontSize: "10px", }}>{selectedSize[item.id] || "No size selected"} </Typography>
                                        </Button>
                    ...
                    {formData ? (
                        <>
                            <Box>
                                <Box>
                                    <Typography color="white" fontSize="12px"  >Dine Method</Typography>
                                ...
                                <Typography color="#AAAAAA" fontSize="12px" >
                                    <span style={{ color: "#797993", marginLeft: "10px" }}>Address : </span>
                                    {formData.address}</Typography>

                                <Typography color="#AAAAAA" fontSize="12px" >
                                    <span style={{ color: "#797993", marginLeft: "10px" }}>Name : </span>
                                    {formData.selectedName}</Typography>

                                <Typography color="#AAAAAA" fontSize="12px" >
                                    <span style={{ color: "#797993", marginLeft: "10px" }}>Phone : </span>
                            ...
                            <Box>
                                <Typography color="white" fontSize="12px" >Comments</Typography>
                                <Typography color="#AAAAAA" fontSize="12px"
                ...
                <Box width={"100%"} sx={{ display: "flex", alignItems: "center" }} >
                    ...
                    <Link href='/orderPlaced' >
                        <Button
                            ...
                            Confirm <img src="/assets/hands.svg" style={{ marginLeft: "5px" }} />
                        </Button>
                    </Link>
